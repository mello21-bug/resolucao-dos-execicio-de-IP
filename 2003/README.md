...
Sobre `EOF` é importante resaltar que tal assunto será visto propriamento em arquivos, mas para nosso exercício tem duas formas para encerrar o programa:

*Linux/Mac*:

Quando o código chega na parte de leitura (`scanf`), aperte simultaneamente CTRL + D, assim o programa se encerra.


*Windows*:

Quando o código chega na parte de leitura (`scanf`), aperte simultaneamente CTRL + Z, assim o programa se encerra.
